...
@app.route('/match_faces', methods=['GET', 'POST'])
def match_faces():
    if request.method == 'POST':
        ...
        # Assuming there's only one face in the ID image, extract and preprocess it
        ...
        # Assuming there's only one face in the selfie image, extract and preprocess it
